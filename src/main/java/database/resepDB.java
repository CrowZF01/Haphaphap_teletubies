...
public class resepDB implements ResepDao {
    ...
    public boolean tambahResepLengkap(int idUser, String judul, int idKategori, int kepedasan, int waktu, int porsi,
        ...
        try (Connection conn = databaseUtil.getConnection()) {
            ...
            // 1. Simpan data resep
            String sqlResep = "INSERT INTO resep (id_user, id_kategori, nama_resep, langkah_pembuatan, waktu_estimasi, porsi_sajian, tingkat_kepedasan, foto, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'PENDING')";
